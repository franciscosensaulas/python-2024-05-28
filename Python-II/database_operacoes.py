...
def popular_registros_tabela_clientes():
    ...
    inserir_registro_tabela_clientes("Sedan", "293.123.542-20")
    inserir_registro_tabela_clientes("Pickup", "382.349.291-20")
    inserir_registro_tabela_clientes("SUV", "102.124.126-20")
